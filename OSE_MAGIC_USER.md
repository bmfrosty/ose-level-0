...
**Spell casting:** Magic-users own spell books containing the formulae for arcane spells. The level progression table shows both the number of spells in the magic-user's spell book and the number they may memorize, determined by the character's experience level. Thus, a 1st level magic-user has one spell in their spell book, selected by the referee (who may allow the player to choose).
...
**Spells:** Number of spells per day by spell level (1st-6th)
