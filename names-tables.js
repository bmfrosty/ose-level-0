...
// Racial abilities functions are now in racial-abilities.js
// In browser environment, they are loaded via <script> tag and available in global scope
// In Node.js environment, we import them here
if (typeof require !== 'undefined' && typeof getRacialAbilities === 'undefined') {
    // Node.js environment - import from racial-abilities.js
    const racialAbilities = require('./racial-abilities.js');
    // Make functions available in this module's scope
    global.getRacialAbilities = racialAbilities.getRacialAbilities;
    global.getCommonDemihumanAbilities = racialAbilities.getCommonDemihumanAbilities;
    global.calculateSavingThrows = racialAbilities.calculateSavingThrows;
    global.calculateAttackBonus = racialAbilities.calculateAttackBonus;
    global.getDwarfResilienceBonus = racialAbilities.getDwarfResilienceBonus;
    global.getGnomeMagicResistanceBonus = racialAbilities.getGnomeMagicResistanceBonus;
    global.getHalflingResilienceBonus = racialAbilities.getHalflingResilienceBonus;
    global.savingThrowsLevel0 = racialAbilities.savingThrowsLevel0;
    global.attackBonusLevel0 = racialAbilities.attackBonusLevel0;
}
// In browser environment, racial-abilities.js is loaded via <script> tag
// and functions are already available in global scope
