...
7. Stays Character-tier, unlike the row above it — only meaningful for the specific human character that had it set (hides "Human" from that one character's race/class display), not a table-wide style choice.
